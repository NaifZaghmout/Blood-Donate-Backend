...
urlpatterns = [
    ...
    path('check-user-logged-in/',
         views.CheckUserLoggedIn.as_view(), name='check_user_logged_in'),
    ...
    path(
        "listpatients/",
        views.PatientBloodListView.as_view(),
        name="patient_blood_list"
    ),
    path('patient-blood/<int:id>/',
         views.PatientBloodDetailView.as_view(),
         name='patient-blood-detail'),
    path(
        "delete/<int:pk>/",
